...
from .rag import get_top_k_food_descriptors, get_top_k_audio_captions
from .mcu import mcu_reprompt

def custom_single_sentence(crossmodal_descriptors: list) -> str:
    crossmodal_suffix_map = {"taste": "melody", "texture": "harmony", "emotion": "rhythm"}
...
def transform(user_prompt: str, prompt_version: str = "V3") -> str:
    ...
    formatted_crossmodal_values = "\n".join(format_crossmodal_descriptors(crossmodal_descriptors))
