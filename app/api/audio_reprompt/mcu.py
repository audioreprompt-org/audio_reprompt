...
from audio_reprompt.prompts import MCU_PROMPTS
from audio_reprompt.config import get_moonshot_api_key
...
def mcu_reprompt(
    crossmodal_descriptors: str, music_captions: str, prompt_version: str = "V3"
) -> str:
    messages = [
    ...
    response = get_client().chat.completions.create(
        model=KIMI_K2_THINKING_MODEL_TURBO, messages=messages
    )
